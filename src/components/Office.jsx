...
export function Office(props) {
  const { nodes, materials } = useGLTF("models/scene/model3.gltf");
  const { section } = props;
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group
        name="keyboard"
        position={[0.018, 0.97, -1.274]}
        rotation={[0.021, -0.452, 0.046]}
        scale={0.674}
      >
        <mesh
          name="mesh425587018"
...
useGLTF.preload("models/scene/model3.gltf");
